...
const card = [
  ...
  topBorder,
  emptyLine,
  createLine(' ' + secondary('{') + highlight('Tim Keogh') + secondary('}') + ' ' + primary('</') + accent('timkeogh.com') + primary('>')),
  divider,
  emptyLine,
  createLine(' ' + secondary('⚙') + '  ' + chalk.cyanBright('Work') + '    :: ' + chalk.white('Software Developer, Epic')),
  createLine(' ' + accent('☁') + '  ' + chalk.cyanBright('Bluesky') + ' :: ' + chalk.cyan('@timk622')),
  createLine(' ' + highlight('★') + '  ' + chalk.cyanBright('GitHub') + '  :: ' + chalk.greenBright.underline('https://github.com/timk622')),
  createLine(' ' + chalk.magentaBright('✉') + '  ' + chalk.cyanBright('Email') + '   :: ' + chalk.greenBright.underline('tim@timkeogh.com')),
  createLine(' ' + chalk.blueBright('⌂') + '  ' + chalk.cyanBright('Web') + '     :: ' + chalk.greenBright.underline('https://www.timkeogh.com')),
  emptyLine,
  divider,
  createLine(' ' + subtle('>') + ' ' + subtle('Run') + ' ' + secondary('npx') + ' ' + highlight('timkeogh') + ' ' + subtle('anytime to see this card')),
  emptyLine,
  bottomBorder,
  ''
].join('\n');
